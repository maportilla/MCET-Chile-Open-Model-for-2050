...
def main(args=None, return_model=False, return_instance=False):
    ...
    with LogOutput(logs_dir):
        ...
        # instance.write("/home/pbcastillo/SWITCH_SEN/Switch_sistema_horario/SW_ESCENARIOS/3ra_corrida/CON_RESTRICCION_ajuste/Referencia_NDC_nuevo/model.lp", io_options={'symbolic_solver_labels':True})
