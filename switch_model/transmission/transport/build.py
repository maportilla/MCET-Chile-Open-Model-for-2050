...
def load_inputs(mod, switch_data, inputs_dir):
    ...
    switch_data.load_aug(
        ...
        select=(
            ...
            'trans_terrain_multiplier', 'trans_new_build_allowed', 'initial_bld_year', 'expansion_year', 'expansion_trans_cap'
        ),
        ...
        param=(
            ...
            mod.trans_terrain_multiplier, mod.trans_new_build_allowed, mod.initial_bld_year, mod.expansion_year, mod.expansion_trans_cap
        )
    )
