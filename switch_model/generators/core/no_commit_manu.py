...
dependencies = 'switch_model.timescales', 'switch_model.balancing.load_zones',\
    ...
    'switch_model.generators.core.build_manu', 'switch_model.generators.core.dispatch'
...
def define_components(mod):
    ...
    mod.Ramping_Constraint_Up = Constraint(
        mod.GEN_TPS,
        rule=lambda m, g, t: (
            m.DispatchGen[g, t] - m.DispatchGen[g, m.tp_previous[t]]
            <= m.gen_ramp_up[g] * m.GenCapacityInTP[g, t]))
    
    mod.Ramping_Constraint_Down = Constraint(
        mod.GEN_TPS,
        rule=lambda m, g, t: (
            m.DispatchGen[g, m.tp_previous[t]] - m.DispatchGen[g, t]
            <= m.gen_ramp_down[g] * m.GenCapacityInTP[g, t]))
