...
def define_components(mod):
    ...
    mod.gen_forced_outage_rate = Param(mod.GENERATION_PROJECTS,
        within=PercentFraction, default=0)
    mod.gen_ramp_up = Param(mod.GENERATION_PROJECTS, within=PercentFraction, default=1)
    mod.gen_ramp_down = Param(mod.GENERATION_PROJECTS, within=PercentFraction, default=1)
...
def load_inputs(mod, switch_data, inputs_dir):
    ...
    switch_data.load_aug(
        ...
        'gen_min_build_capacity', 'gen_is_cogen', 'gen_is_distributed','gen_ramp_up','gen_ramp_down'],
        ...
        param=(mod.gen_dbid, mod.gen_tech, mod.gen_energy_source,
               ...
               mod.gen_is_distributed, mod.gen_ramp_up, mod.gen_ramp_down))
